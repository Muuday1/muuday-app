-- ============================================
-- Wave 2 patch: remove jurisdiction from signup pipeline
-- ============================================
-- Goals:
-- 1) Keep professional onboarding global (no jurisdiction field)
-- 2) Ensure handle_new_user works after dropping professional_applications.jurisdiction
