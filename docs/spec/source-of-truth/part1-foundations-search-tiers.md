...
* professional\_specialty relation
* service\_specialty relation if needed
...
* search\_opened
* search\_query\_submitted
* filter\_applied
* result\_clicked
* professional\_profile\_viewed
* service\_viewed
* favorite\_added
...
* professional\_signup\_started
* professional\_profile\_completed
* professional\_submitted\_for\_review
* professional\_published
* plan\_selected
* trial\_started

10.5 Trust/review events relevant to this part

* review\_prompt\_shown
* review\_submitted
* private\_feedback\_submitted
