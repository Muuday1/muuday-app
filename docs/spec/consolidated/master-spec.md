...
2. ~~BR rail provider final selection~~ → **RESOLVED 2026-04-24**
- Payment architecture is locked as entity-based dual rail.
- UK entity uses Stripe for pay-in and Revolut Business for treasury.
- **Payout provider: Trolley is primary for all corridors including BR.** Airwallex and dLocal are contingency-only evaluations.
