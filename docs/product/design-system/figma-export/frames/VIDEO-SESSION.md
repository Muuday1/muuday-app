# Video Session — Figma Frame Specs

> **Journey:** Video session lobby, active call, end screen  
> **Source:** `docs/product/design-system/frames/video-session.md`

---

## Frame 1: Session Lobby (`/sessao/[id]/lobby`)
...
| 2 | Session Info | Card/Info | (360, 96) | (720, 120) | bg: surface-card, border: neutral-200 | Top, Center |
...
| 6 | Countdown | Text/Overlay | (680, 260) | (80, 24) | font: text-sm, color: white/80 | Top, Center |
| 7 | Device Controls | Toolbar | (540, 720) | (360, 56) | gap: 16px | Center, Bottom |
| 8 | Mic | IconButton | (540, 720) | (56, 56) | bg: neutral-200, radius: radius-full | Bottom |
| 9 | Cam | IconButton | (612, 720) | (56, 56) | bg: neutral-200, radius: radius-full | Bottom |
| 10 | Speaker | IconButton | (684, 720) | (56, 56) | bg: neutral-200, radius: radius-full | Bottom |
| 11 | Join Button | Button/Primary | (520, 800) | (400, 48) | bg: primary-500 | Bottom, Center |

---

## Frame 2: Active Call (`/sessao/[id]`)
...
| 10 | Chat Drawer | Drawer/Right | (1080, 64) | (360, 836) | bg: surface-elevated, shadow: shadow-lg | Right |

---

## Frame 3: End Screen (`/sessao/[id]/review`)
...
|---|------------|-----------|----------|------|--------|-------------|
| 1 | Header | Shell/Header | (0, 0) | (1440, 64) | bg: surface-page | Top |
| 2 | Summary Card | Card/Section | (360, 96) | (720, 140) | bg: surface-card, border: neutral-200 | Top, Center |
...
| 6 | Review Textarea | Textarea | (360, 408) | (720, 120) | bg: surface-card, border: neutral-200 | Top, Left+Right |
| 7 | Submit Button | Button/Primary | (560, 552) | (320, 48) | bg: primary-500 | Top, Center |

---

*Figma specs complete for Video Session.*
