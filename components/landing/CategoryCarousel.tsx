      ...
      >
        {ALL_CATEGORIES.map((category) => (
          <Link
            ...
            className="group flex w-[260px] shrink-0 snap-start flex-col rounded-lg border border-slate-200 bg-white p-8 transition hover:border-[#9FE870] hover:-translate-y-1"
          >
            ...
            <div className="relative mx-auto flex h-20 w-20 items-center justify-center">
              ...
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#9FE870] to-emerald-500 transition group-hover:scale-110">
            ...
            <p className="mt-4 inline-flex items-center justify-center gap-1 text-sm font-bold text-[#3d6b1f] transition group-hover:text-slate-900">
              Ver profissionais
