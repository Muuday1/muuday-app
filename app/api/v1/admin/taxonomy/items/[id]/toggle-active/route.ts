...
export async function PATCH(
  ...
  const { type, currentActive } = body as { type: Parameters<typeof toggleTaxonomyActiveService>[1]; currentActive: boolean }

  const result = await toggleTaxonomyActiveService(supabase, type, id, currentActive)
