  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className={`rounded-xl border p-3 ${hasBlocker('missing_billing_card') ? 'border-amber-200 bg-amber-50' : 'border-green-200 bg-green-50'}`}>
        ...
        <div className={`rounded-xl border p-3 ${hasBlocker('missing_payout_onboarding') ? 'border-amber-200 bg-amber-50' : 'border-green-200 bg-green-50'}`}>
        ...
        <div className={`rounded-xl border p-3 ${hasBlocker('missing_payout_kyc') ? 'border-amber-200 bg-amber-50' : 'border-green-200 bg-green-50'}`}>
