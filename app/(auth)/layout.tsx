    ...
    <div className="min-h-screen bg-[#f6f4ef] flex">
      <div className="hidden lg:flex lg:w-1/2 bg-brand-500 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <Link
            href="/"
            className="inline-flex items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <Link
            href="/"
            className="mb-8 inline-flex items-center gap-2 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 lg:hidden"
            aria-label="Ir para a página inicial"
          >
