    ...
    <div className="mx-auto max-w-6xl p-6 md:p-8">
      ...
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="space-y-2">
          <div className="h-8 w-40 rounded-lg bg-neutral-200 animate-pulse" />
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-4">
        ...
        <div className="grid grid-cols-7 gap-1">
          {Array.from({ length: 35 }).map((_, i) => (
            <div
              key={i}
              className="aspect-square rounded-lg border border-neutral-100 bg-neutral-100 animate-pulse"
            />
          ))}
        </div>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-4">
        <div className="mb-3 h-5 w-40 rounded bg-neutral-200 animate-pulse" />
