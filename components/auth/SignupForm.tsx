...
export default function SignupForm({ initialCatalog, redirectPath, requestedRole, origin }: SignupFormProps) {
  ...
  // Props redirectPath and requestedRole are passed from Server Component
  ...
  // Initialize catalog from server props
  useEffect(() => {
    if (role !== 'profissional') return
  ...
  // Catalog loaded server-side via initialCatalog prop
