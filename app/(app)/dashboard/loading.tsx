    ...
    <div className="mx-auto max-w-5xl p-6 md:p-8">
      ...
      <div className="mb-6 rounded-2xl border border-neutral-200 bg-white p-4">
        <div className="flex items-start gap-3">
          <div className="h-5 w-5 shrink-0 rounded-full bg-neutral-200 animate-pulse" />
          <div className="flex-1 space-y-2">
            <div className="h-5 w-64 rounded bg-neutral-200 animate-pulse" />
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-neutral-200 bg-white p-4">
            ...
            <div className="mt-2 h-7 w-12 rounded bg-neutral-200 animate-pulse" />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="rounded-2xl border border-neutral-200 bg-white p-4">
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 border-t border-neutral-100 py-3 first:border-0">
                <div className="h-10 w-10 shrink-0 rounded-full bg-neutral-200 animate-pulse" />
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-neutral-200 bg-white p-4">
            <div className="mb-3 h-5 w-28 rounded bg-neutral-200 animate-pulse" />
            <div className="space-y-2">
              {Array.from({ length: 4 }).map((_, i) => (
