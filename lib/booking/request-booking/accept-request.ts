...
import { extractProfessionalTimezone, loadProfessionalSettings } from '@/lib/booking/settings'
...
import { requestIdSchema, isActiveSlotCollision } from '@/lib/booking/request-validation'
import {
