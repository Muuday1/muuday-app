    ...
    <div className="min-h-screen bg-slate-50 flex">
      <div className="hidden lg:flex lg:w-1/2 bg-[#9FE870] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <blockquote className="text-white/90 text-2xl font-display font-semibold leading-tight mb-6">
            &quot;Profissionais brasileiros<br />de confiança, onde você estiver.&quot;
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white text-sm font-bold">🌍</div>
            <p className="text-white/70 text-sm">Para brasileiros que não abrem mão da qualidade</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <Link
            href="/"
            className="mb-8 inline-flex items-center gap-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9FE870]/40 lg:hidden"
            aria-label="Ir para a página inicial"
          >
            <div className="w-8 h-8 bg-[#9FE870] rounded-xl flex items-center justify-center">
              <span className="text-white font-display font-bold">M</span>
            </div>
            <span className="font-display font-bold text-xl text-slate-900">muuday</span>
          </Link>
          {children}
        </div>
      </div>
