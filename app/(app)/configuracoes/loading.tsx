    ...
    <div className="mx-auto max-w-5xl p-6 md:p-8">
      ...
      <div className="mb-6 flex gap-2 border-b border-neutral-200 pb-1">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="h-9 w-28 rounded-t-lg bg-neutral-200 animate-pulse" />
        ))}
      </div>
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-neutral-200 bg-white p-5">
          <div className="mb-4 h-5 w-36 rounded bg-neutral-200 animate-pulse" />
          <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-5">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="h-10 w-full max-w-md rounded-xl bg-neutral-200 animate-pulse" />
            </div>
            <div>
              <div className="mb-1 h-4 w-24 rounded bg-neutral-200 animate-pulse" />
              <div className="h-10 w-full max-w-md rounded-xl bg-neutral-200 animate-pulse" />
