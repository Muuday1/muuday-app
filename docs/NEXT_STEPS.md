...
- **Acceptance:**
  ...
  - [x] `components/booking/BookingForm.tsx` (~~1,295~~ **752 lines**) → extracted 9 presentational components into `components/booking/booking-form/components/`. Remaining: custom hooks extraction (useCalendarSlots, useRecurringBooking, useBatchBooking, useBookingSubmission)
