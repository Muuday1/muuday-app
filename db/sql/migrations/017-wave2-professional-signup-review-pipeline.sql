-- ============================================
-- Wave 2: Professional signup review pipeline
-- ============================================
-- Goals:
-- 1) Persist professional signup application details for admin validation.
-- 2) Auto-create/refresh a draft professional row on professional signup.
-- 3) Route custom specialty suggestions into moderation queue.
...
CREATE UNIQUE INDEX IF NOT EXISTS professional_applications_user_uidx
...
DROP POLICY IF EXISTS "Professionals can view own applications" ON public.professional_applications;
...
DROP POLICY IF EXISTS "Professionals can insert own applications" ON public.professional_applications;
...
DROP POLICY IF EXISTS "Admins can update applications" ON public.professional_applications;
