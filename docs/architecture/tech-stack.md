...
| --- | --- | --- | --- | --- |
| Database composite indexes | Query performance for booking/search paths | In progress (migration `020` criada) | Wave 2 close | `EXPLAIN ANALYZE` mostra seq scans ap�s aplica��o dos �ndices |
