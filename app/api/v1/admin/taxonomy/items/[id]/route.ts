...
export async function PATCH(
  ...
  const { type, data } = body as { type: Parameters<typeof updateTaxonomyItemService>[1]; data: Parameters<typeof updateTaxonomyItemService>[3] }

  const result = await updateTaxonomyItemService(supabase, type, id, data)
