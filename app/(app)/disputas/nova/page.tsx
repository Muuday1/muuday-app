...
export default async function NovaDisputaPage({
  ...
  return (
    <div className="mx-auto max-w-2xl p-6 md:p-8">
      ...
      <div className="mb-6">
        <h1 className="font-display text-2xl font-bold text-neutral-900 md:text-3xl">Abrir caso</h1>
        <p className="mt-1 text-sm text-neutral-500">Descreva o problema para que possamos ajudar.</p>
      </div>

      <form action={handleSubmit} className="rounded-2xl border border-neutral-100 bg-white p-6 space-y-4">
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-neutral-600">Agendamento relacionado</label>
          <select
            name="bookingId"
            defaultValue={bookingId || ''}
            required
            className="w-full rounded-xl border border-neutral-200 bg-neutral-50 px-3 py-2.5 text-sm transition focus:border-brand-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-200"
          >
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-neutral-600">Tipo de caso</label>
          <select
            name="type"
            required
            className="w-full rounded-xl border border-neutral-200 bg-neutral-50 px-3 py-2.5 text-sm transition focus:border-brand-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-200"
