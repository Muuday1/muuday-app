...
3. ✅ Confirm `pgcrypto` and `vault` extension availability in production.
4. ⏳ Complete secrets rotation baseline (see `docs/engineering/runbooks/secrets-rotation-runbook.md`):
   ...
   - `TROLLEY_API_KEY`, `TROLLEY_API_SECRET`, `TROLLEY_WEBHOOK_SECRET`
   - `REVOLUT_CLIENT_ID`, `REVOLUT_API_KEY`
