...
function g(slug, title, category, excerpt, readTime, date, content, steps, tips, relatedGuides) {
  GUIDES.push({ slug, title, category, excerpt, readTime, date, content, steps, tips, relatedGuides });
}

// === DOCUMENTOS ===
g('cpf-regularizado-exterior',
  'Como manter seu CPF regularizado morando no exterior',
  'documentos',
  'CPF suspenso, cancelado ou pendente de regularização? Guia passo a passo para resolver sua situação cadastral à distância, evitar bloqueios e manter suas contas liberadas.',
  '12 min', '18 de abril de 2026',
  [
  ...
  [
    { title: 'Consulte a situação', description: 'Acesse consultasituacao.cpf e anote o motivo exato da irregularidade.' },
    { title: 'Reúna documentos', description: 'Passaporte, comprovante de residência no exterior, certidão de nascimento atualizada e declarações de IR pendentes.' },
    { title: 'Acesse o e-CAC', description: 'Crie/acesse conta gov.br (nível prata ou ouro) e vá em Meu CPF > Regularizar.' },
    { title: 'Preencha e anexe', description: 'Informe o motivo da regularização, anexe os documentos e guarde o protocolo.' },
    { title: 'Aguarde e confirme', description: 'Prazo médio de 5-10 dias úteis. Consulte novamente para confirmar a regularização.' },
  ],
  [
    { title: 'Conta gov.br no exterior', text: 'Você pode validar sua conta gov.br pelo app da Caixa ou de bancos brasileiros, mesmo sem estar no Brasil. Alguns consulados também oferecem apoio.' },
    { title: 'Procuração digital', text: 'Se o caso for complexo, dê procuração a um contador ou advogado no Brasil. A procuração pode ser feita por meio eletrônico no e-CAC.' },
    { title: 'Mantenha endereço atualizado', text: 'Atualize seu endereço no exterior sempre que mudar. Um endereço desatualizado é uma das principais causas de suspensão.' },
  ],
  ['declaracao-saida-definitiva', 'imposto-renda-exterior', 'conta-bancaria-brasil']
);

g('passaporte-brasileiro-exterior',
  'Como tirar ou renovar passaporte brasileiro no exterior',
  'documentos',
  'Passaporte vencendo ou perdido? Veja como solicitar, renovar ou emitir segunda via diretamente no consulado brasileiro do país onde reside.',
  '10 min', '16 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique prazos', description: 'Confira a validade do seu passaporte atual e os prazos exigidos pelo país onde reside.' },
    { title: 'Reúna documentos', description: 'RG/CNH, comprovante de residência, foto 5x7 cm fundo branco e passaporte anterior.' },
    { title: 'Preencha no e-Consular', description: 'Acesse o sistema, preencha o formulário de passaporte e gere a GRU para pagamento.' },
    { title: 'Pague a GRU', description: 'O pagamento pode ser feito em bancos brasileiros, lotéricas ou via transferência internacional (consulte o consulado).' },
    { title: 'Agende e compareça', description: 'Marque o dia no e-Consular, leve os originais e faça a biometria no consulado.' },
    { title: 'Retire ou receba', description: 'Aguarde o prazo de confecção e retire pessoalmente ou por correio, conforme opção do consulado.' },
  ],
  [
    { title: 'Agende com antecedência', text: 'Consulados costumam ter filas de espera de semanas ou meses. Não deixe para a última hora.' },
    { title: 'Fotos específicas', text: 'Alguns consulados são rigorosos com as fotos. Faça em estúdio fotográfico que conheça os requisitos do Itamaraty.' },
    { title: 'Passaporte de emergência', text: 'Se perdeu o passaporte e precisa viajar urgentemente, solicite passaporte de emergência. É válido por menos tempo, mas resolve imediatamente.' },
  ],
  ['cpf-regularizado-exterior', 'certidoes-exterior', 'declaracao-saida-definitiva']
);

g('certidoes-exterior',
  'Como obter certidões de nascimento e casamento do Brasil morando no exterior',
  'documentos',
  'Precisa de certidão atualizada para processo de cidadania, casamento no exterior ou regularização? Veja como solicitar à distância e receber onde estiver.',
  '8 min', '14 de abril de 2026',
  [
  ...
  [
    { title: 'Identifique o cartório', description: 'Descubra qual é o cartório de registro civil do município brasileiro onde nasceu/casou.' },
    { title: 'Verifique opções online', description: 'Acesse o site do cartório ou registrocivil.org.br para solicitar digitalmente.' },
    { title: 'Preencha e pague', description: 'Informe seus dados, selecione o tipo de certidão e efetue o pagamento.' },
    { title: 'Receba por email', description: 'O documento chega em PDF em poucos dias. Verifique se está com todos os dados corretos.' },
    { title: 'Apostile se necessário', description: 'Se for usar no exterior, verifique se precisa de apostila de Haia e solicite junto ao cartório ou tribunal.' },
  ],
  [
    { title: 'Certidão atualizada', text: 'Certidões antigas (mais de 90 dias) podem não ser aceitas para alguns processos no exterior. Sempre peça a mais recente.' },
    { title: 'Tradução juramentada', text: 'Além da apostila, alguns países exigem tradução juramentada para o idioma local. Verifique antes de gastar dinheiro.' },
    { title: 'Procuração no Brasil', text: 'Se precisar de certidão antiga ou de cartório sem sistema online, dê procuração a um familiar ou despachante no Brasil.' },
  ],
  ['passaporte-brasileiro-exterior', 'casamento-exterior-reconhecimento', 'cidadania-europeia']
);

// === IMPOSTOS ===
g('declaracao-saida-definitiva',
  ...
  [
    { title: 'Comunique a saída', description: 'Acesse o e-CAC e envie a Comunicação de Saída Definitiva até fevereiro do ano seguinte à saída.' },
    { title: 'Reúna documentação', description: 'Informes de rendimentos, extratos bancários, escrituras, comprovante de saída (passagem ou contrato de trabalho).' },
    { title: 'Preencha a DSDP', description: 'No programa do IRPF do ano seguinte, selecione "Declaração de Saída Definitiva" e preencha todos os dados até a data de saída.' },
    { title: 'Indique procurador', description: 'Nomeie um representante fiscal no Brasil para receber notificações e resolver pendências.' },
    { title: 'Transmita e guarde recibo', description: 'Envie a declaração dentro do prazo e guarde o recibo de entrega comprovante.' },
    { title: 'Atualize cadastros', description: 'Informe bancos, empregadores e outros que você é não residente fiscal.' },
  ],
  [
    { title: 'Prazo é rigoroso', text: 'A DSDP deve ser entregue até o final de maio do ano seguinte à saída. Atraso gera multa de 1% ao mês (limite 20%) mais juros SELIC.' },
    { title: 'Bens no Brasil', text: 'Você pode (e deve) manter bens no Brasil mesmo como não residente. Eles devem ser declarados na DSDP e não precisam ser vendidos.' },
    { title: 'Restituição', text: 'Se tiver direito a restituição de IR, ela só pode ser depositada em conta bancária no Brasil. Mantenha uma conta ativa.' },
  ],
  ['imposto-renda-exterior', 'cpf-regularizado-exterior', 'investimentos-exterior']
);

g('imposto-renda-exterior',
  'Imposto de Renda para brasileiros no exterior: o que você realmente precisa declarar',
  'impostos',
  'Morando fora, você ainda tem obrigações com a Receita Federal. Descubra o que declarar, o que não declarar e como evitar a temida malha fina.',
  '14 min', '18 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique sua condição fiscal', description: 'Você é residente ou não residente? Isso define todas as suas obrigações.' },
    { title: 'Liste rendimentos no Brasil', description: 'Aluguéis, ganhos de capital, aplicações, heranças — tudo que vem de fonte brasileira.' },
    { title: 'Verifique acordos internacionais', description: 'Consulte se o Brasil tem acordo de bitributação com o país onde reside.' },
    { title: 'Obtenha certidão de residência fiscal', description: 'Solicite no país de residência para comprovar que já paga impostos lá.' },
    { title: 'Declare ou regularize', description: 'Entregue a declaração no prazo ou faça retificação retroativa se estiver em atraso.' },
  ],
  [
    { title: 'Contador especializado', text: 'Impostos internacionais são complexos. Invista em um contador que entenda de expatriados. O custo do contador é muito menor que o custo de uma multa.' },
    { title: 'Mantenha registros', text: 'Guarde todos os comprovantes de pagamento de impostos no exterior por pelo menos 5 anos. Você pode precisar comprovar para a Receita Federal.' },
    { title: 'Não ignore notificações', text: 'Se receber comunicação da Receita Federal, responda no prazo. Ignorar só piora a situação e aumenta as multas.' },
  ],
  ['declaracao-saida-definitiva', 'investimentos-exterior', 'cpf-regularizado-exterior']
);

g('investimentos-exterior',
  'Como declarar investimentos no exterior morando fora do Brasil',
  'impostos',
  'Tem conta em corretora americana, criptomoedas ou imóveis no exterior? Entenda suas obrigações fiscais no Brasil e no país de residência.',
  '11 min', '15 de abril de 2026',
  [
  ...
  [
    { title: 'Liste todos os ativos no exterior', description: 'Corretoras, contas bancárias, imóveis, criptomoedas, participações societárias.' },
    { title: 'Verifique obrigações no Brasil', description: 'Se residente: IRPF + CBE (se > US$ 100k). Se não residente: só rendimentos de fonte brasileira.' },
    { title: 'Entenda regras do país de residência', description: 'Cada país taxa diferente. Consulte um contador local especializado.' },
    { title: 'Documente transações', description: 'Guarde comprovantes de compra, venda, dividendos e ganhos de capital por pelo menos 5 anos.' },
    { title: 'Declare nos dois países se necessário', description: 'Use acordos de bitributação para evitar pagar duas vezes sobre o mesmo ganho.' },
  ],
  [
    { title: 'CBE esquecida', text: 'Muitos brasileiros no exterior esquecem a CBE. É uma declaração separada do IRPF, obrigatória anualmente para ativos > US$ 100k. Multa por omissão pode chegar a R$ 5.000.' },
    { title: 'Exchange de cripto', text: 'Use exchanges que emitam relatórios fiscais. Isso facilita drasticamente a declaração. Binance, Coinbase e Kraken oferecem relatórios anuais.' },
    { title: 'Planejamento tributário', text: 'Estruturar seus investimentos de forma inteligente pode economizar milhares em impostos. Um planejador financeiro internacional vale o investimento.' },
  ],
  ['imposto-renda-exterior', 'declaracao-saida-definitiva', 'conta-bancaria-brasil']
);

g('mei-cnpj-exterior',
  'Como manter CNPJ e MEI no Brasil morando no exterior',
  'impostos',
  'Empreender à distância é possível. Saiba como manter seu CNPJ ativo, emitir nota fiscal de fora e cumprir obrigações acessórias sem dor de cabeça.',
  '10 min', '12 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique viabilidade', description: 'Sua atividade permite MEI? Se não, qual regime tributário é mais vantajoso?' },
    { title: 'Contrate contador no Brasil', description: 'Alguém que entenda de empresas com sócio no exterior e possa operar por procuração.' },
    { title: 'Abra ou mantenha CNPJ', description: 'Registre no município ou mantenha o existente atualizado com endereço e email válidos.' },
    { title: 'Configure emissão de nota', description: 'Obtenha certificado digital e configure acesso ao sistema da prefeitura para emissão remota.' },
    { title: 'Pague obrigações em dia', description: 'DAS mensal, declarações trimestrais/anuais. Use débito automático ou pague por internet banking.' },
    { title: 'Dê procuração ao contador', description: 'Facilite a vida dele (e a sua) permitindo que ele resolva burocracias em seu nome.' },
  ],
  [
    { title: 'Certificado digital', text: 'O certificado digital A1 ou A3 é obrigatório para emitir nota fiscal e transmitir declarações. Renove antes do vencimento.' },
    { title: 'Endereço fiscal', text: 'Você pode usar o endereço do contador, de um familiar ou de um espaço de coworking como endereço fiscal da empresa.' },
    { title: 'Faturamento em moeda estrangeira', text: 'Nota fiscal para cliente no exterior deve ser emitida em reais, convertendo pelo câmbio do dia. Guarde o comprovante da taxa usada.' },
  ],
  ['nota-fiscal-exterior', 'imposto-renda-exterior', 'conta-bancaria-brasil']
);

// === BANCOS ===
g('conta-bancaria-brasil',
  'Como manter conta bancária no Brasil morando no exterior',
  'bancos',
  'Conta bloqueada? Banco exigindo presença? Veja como manter, reativar ou abrir conta bancária no Brasil à distância, sem precisar voltar ao país.',
  '12 min', '20 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique situação do CPF', description: 'Conta bloqueada geralmente começa com CPF irregular. Resolva isso primeiro.' },
    { title: 'Atualize cadastro no banco', description: 'Informe novo endereço no exterior, email e telefone. Use app, internet banking ou procuração.' },
    { title: 'Verifique limites', description: 'Contas de não residentes podem ter limites de saque e transferência. Entenda as regras do seu banco.' },
    { title: 'Configure acesso digital', description: 'Mantenha app atualizado, token ativo e senhas em dia para operar à distância.' },
    { title: 'Escolha canal de remessas', description: 'Compare Wise, Remitly, bancos e cripto para encontrar a melhor opção para suas transferências.' },
  ],
  [
    { title: 'Não deixe conta inativa', text: 'Faça pelo menos uma movimentação a cada 6 meses. Contas inativas por longos períodos podem ser encerradas pelo banco.' },
    { title: 'Token físico', text: 'Se o banco usar token físico, leve-o com você no exterior. Sem ele, algumas operações ficam bloqueadas.' },
    { title: 'Múltiplos bancos', text: 'Não dependa de um único banco. Ter contas em dois bancos diferentes reduz risco de ficar sem acesso.' },
  ],
  ['cpf-regularizado-exterior', 'enviar-dinheiro-exterior', 'declaracao-saida-definitiva']
);

g('enviar-dinheiro-exterior',
  'Como enviar e receber dinheiro entre Brasil e exterior: todas as opções comparadas',
  'bancos',
  'Wise, Remitly, banco, cripto ou Western Union? Compare taxas, prazos, limites e burocracia de cada método para escolher o ideal para você.',
  '13 min', '17 de abril de 2026',
  [
  ...
  [
    { title: 'Defina valor e frequência', description: 'Transferência única ou recorrente? Valor pequeno ou grande? Isso muda a melhor opção.' },
    { title: 'Compare taxas totais', description: 'Não olhe só a taxa de transferência. Some taxa + spread cambial + possível taxa de recebimento.' },
    { title: 'Verifique limites e burocracia', description: 'Para valores acima de R$ 10.000 ou equivalente, pode ser necessário comprovar origem dos recursos.' },
    { title: 'Teste com valor pequeno', description: 'Antes de enviar quantias grandes, faça um teste com valor pequeno para confirmar que tudo funciona.' },
    { title: 'Guarde comprovantes', description: 'Documente todas as transferências para possíveis questionamentos fiscais futuros.' },
  ],
  [
    { title: 'Câmbio do dia', text: 'As taxas de câmbio flutuam durante o dia. Se o valor for grande, acompanhe o câmbio e envie em momento favorável.' },
    { title: 'Limite anual', text: 'O Brasil tem limite de US$ 150.000 por ano para remessas ao exterior por CPF (acima disso, exige autorização do Banco Central).' },
    { title: 'Stablecoins para freelancers', text: 'Se você recebe de clientes internacionais, stablecoins (USDC, USDT) são uma opção rápida e barata, mas documente tudo para fins fiscais.' },
  ],
  ['conta-bancaria-brasil', 'investimentos-exterior', 'mei-cnpj-exterior']
);

// === PREVIDENCIA ===
g('inss-contribuicao-exterior',
  ...
  [
    { title: 'Verifique seu tempo de contribuição', description: 'Acesse o Meu INSS e consulte quanto tempo você já tem acumulado.' },
    { title: 'Escolha o valor da contribuição', description: 'Defina um valor entre salário mínimo e teto previdenciário que faça sentido para seu orçamento.' },
    { title: 'Emita a GPS', description: 'Gere a guia no site do INSS ou app Meu INSS. Selecione a categoria correta (contribuinte individual).' },
    { title: 'Pague a guia', description: 'Use boleto (conta no Brasil) ou transferência internacional para a conta do INSS indicada na guia.' },
    { title: 'Guarde comprovantes', description: 'Documente todos os pagamentos. Eles serão essenciais na hora de solicitar a aposentadoria.' },
    { title: 'Faça prova de vida anual', description: 'Se já é beneficiário, não esqueça da prova de vida no consulado ou pelo app.' },
  ],
  [
    { title: 'Contribuição mensal', text: 'A contribuição precisa ser feita todos os meses. Uma falta não invalida o tempo anterior, mas interrompe a continuidade, que pode ser importante para alguns tipos de aposentadoria.' },
    { title: 'Meu INSS no exterior', text: 'O app Meu INSS funciona de qualquer lugar do mundo. Use-o para consultar tempo de contribuição, emitir guias e acompanhar processos.' },
    { title: 'Imposto de 25%', text: 'Aposentadorias recebidas no exterior têm retenção de 25% de IR na fonte. Isso pode ser contestado judicialmente em alguns casos. Consulte um advogado previdenciário.' },
  ],
  ['cpf-regularizado-exterior', 'declaracao-saida-definitiva', 'aposentadoria-exterior']
);

g('aposentadoria-exterior',
  'Como receber aposentadoria do INSS morando no exterior',
  'previdencia',
  'Já é aposentado e se mudou? Veja como transferir seu benefício para o exterior, fazer prova de vida e evitar a suspensão do pagamento.',
  '10 min', '19 de abril de 2026',
  [
  ...
  [
    { title: 'Informe mudança de endereço', description: 'Comunique ao INSS seu novo endereço no exterior pelo Meu INSS ou consulado.' },
    { title: 'Solicite transferência', description: 'Peça transferência do benefício para conta no exterior ou mantenha conta no Brasil.' },
    { title: 'Agende prova de vida', description: 'Marque no consulado brasileiro ou use o app Meu INSS para fazer a prova de vida anual.' },
    { title: 'Envie documentação', description: 'Envie o atestado de prova de vida e comprovante de residência ao INSS conforme instruções.' },
    { title: 'Acompanhe pagamentos', description: 'Verifique se os depósitos estão ocorrendo regularmente. Em caso de atraso, contate o INSS imediatamente.' },
  ],
  [
    { title: 'Não deixe acumular', text: 'Se o pagamento for suspenso, resolva o mais rápido possível. Quanto mais tempo passa, mais difícil é reaver valores retroativos.' },
    { title: 'Procuração', text: 'Dê procuração a um advogado ou familiar no Brasil para resolver pendências do INSS em seu nome.' },
    { title: 'Conta no Brasil', text: 'Mesmo morando no exterior, manter uma conta bancária no Brasil facilita o recebimento e evita complicações com transferências internacionais.' },
  ],
  ['inss-contribuicao-exterior', 'cpf-regularizado-exterior', 'conta-bancaria-brasil']
);

// === SAUDE ===
g('plano-saude-brasil-exterior',
  'Plano de saúde no Brasil morando no exterior: vale a pena manter?',
  'saude',
  'Muitos brasileiros mantêm plano de saúde no Brasil para quando voltam a visitar. Saiba quando vale a pena, como escolher e o que observar na contratação.',
  '9 min', '21 de abril de 2026',
  [
  ...
  [
    { title: 'Avalie frequência de visitas', description: 'Você vai ao Brasil pelo menos uma vez por ano? Usaria o plano nessas visitas?' },
    { title: 'Considere idade e saúde', description: 'Tem mais de 50 anos ou condições pré-existentes? A readmissão futura pode ser difícil ou cara.' },
    { title: 'Compare preços', description: 'Plano no Brasil + seguro saúde local pode sair mais barato que plano internacional.' },
    { title: 'Verifique carência', description: 'Se cancelar e voltar depois, terá que cumprir carência novamente. Calcule se vale a pena.' },
    { title: 'Decida e execute', description: 'Mantenha, reduza categoria ou cancele. Se mantiver, atualize endereço para correspondência eletrônica.' },
  ],
  [
    { title: 'Telemedicina', text: 'Muitos planos brasileiros agora oferecem telemedicina. Você pode fazer consultas online mesmo morando no exterior, mas verifique se o serviço permite atendimento de fora do Brasil.' },
    { title: 'Correspondência', text: 'Atualize seu endereço no plano para email ou endereço de familiar no Brasil. Boletos e comunicações importantes precisam chegar.' },
    { title: 'Seguro viagem', text: 'Se mantém plano no Brasil mas viaja para outros países, contrate seguro viagem separado. O plano brasileiro não cobre atendimento no exterior (exceto emergências em alguns planos internacionais).' },
  ],
  ['vacinas-expatriados', 'primeira-consulta-profissional-online']
);

g('vacinas-expatriados',
  'Vacinas e saúde preventiva para brasileiros no exterior',
  'saude',
  'Quais vacinas você precisa antes de viajar? E depois de chegar? Guia completo de imunização, exames preventivos e cuidados de saúde para expatriados.',
  '8 min', '16 de abril de 2026',
  [
  ...
  [
    { title: 'Consulte calendário do destino', description: 'Pesquise o calendário vacinal e exigências de entrada do país onde vai morar.' },
    { title: 'Atualize vacinas no Brasil', description: 'Tome vacinas pendentes antes de viajar. É mais fácil e geralmente gratuito no SUS.' },
    { title: 'Leve documentação', description: 'Cartão de vacinação, receitas médicas, relatórios de exames — tudo traduzido se possível.' },
    { title: 'Encontre médico local', description: 'Cadastre-se no sistema de saúde local ou contrate seguro privado. Tenha um médico de referência.' },
    { title: 'Faça check-up anual', description: 'Não deixe exames preventivos de lado. Agende uma vez por ano, mesmo que seja por telemedicina.' },
  ],
  [
    { title: 'Cartão de vacina digital', text: 'Alguns países aceitam comprovante digital de vacinação. Verifique se o país de destino reconhece o ConecteSUS ou app similar.' },
    { title: 'Remédios controlados', text: 'Medicamentos controlados (ansiolíticos, opioides) podem ser proibidos em alguns países ou exigir documentação especial. Pesquise antes de levar.' },
    { title: 'Plano de saúde local', text: 'Mesmo que tenha plano no Brasil, entenda como funciona o sistema de saúde do país onde reside. Saber onde ir em emergência pode salvar sua vida.' },
  ],
  ['plano-saude-brasil-exterior', 'primeira-consulta-profissional-online']
);

// === EDUCACAO ===
g('revalidacao-diploma-exterior',
  'Como revalidar diploma brasileiro no exterior',
  'educacao',
  'Seu diploma vale no exterior? Saiba como fazer reconhecimento, revalidação e equivalência de estudos em diferentes países.',
  '11 min', '19 de abril de 2026',
  [
  ...
  [
    { title: 'Pesquise o processo do país', description: 'Cada país tem regras diferentes. Acesse o site oficial do órgão responsável.' },
    { title: 'Apostile documentos no Brasil', description: 'Diploma, histórico e programas de disciplinas devem ser apostilados antes de sair.' },
    { title: 'Traduza juramentadamente', description: 'Contrate tradutor juramentado no país de destino para traduzir todos os documentos.' },
    { title: 'Envie a solicitação', description: 'Preencha formulários, pague taxas e envie documentação conforme exigido.' },
    { title: 'Acompanhe e responda', description: 'O órgão pode pedir documentos adicionais. Responda rápido para não atrasar.' },
  ],
  [
    { title: 'Programas de disciplinas', text: 'Muitos processos exigem o conteúdo programático de cada matéria. Solicite na faculdade brasileira antes de se formar ou se mudar.' },
    { title: 'Registro profissional', text: 'Diploma revalidado não garante exercício profissional. Muitas profissões exigem registro no conselho local (medicina, engenharia, psicologia, direito).' },
    { title: 'Custo e prazo', text: 'Revalidação pode custar de € 100 a € 2.000+ e levar de 3 meses a 2 anos. Programe-se financeira e temporalmente.' },
  ],
  ['revalidacao-diploma-brasil', 'trabalho-direitos-exterior']
);

g('revalidacao-diploma-brasil',
  'Como revalidar diploma estrangeiro no Brasil',
  'educacao',
  'Estudou no exterior e quer exercer no Brasil? Veja como funciona a revalidação de diploma estrangeiro no Brasil, passo a passo.',
  '9 min', '14 de abril de 2026',
  [
  ...
  [
    { title: 'Encontre universidade credenciada', description: 'Consulte o e-MEC ou entre em contato com universidades que ofereçam curso equivalente ao seu.' },
    { title: 'Reúna documentação', description: 'Diploma apostilado, histórico, programas de disciplinas, identidade e CPF.' },
    { title: 'Envie solicitação', description: 'Preencha o formulário da universidade, pague a taxa e envie os documentos.' },
    { title: 'Aguarde análise', description: 'A universidade analisa equivalência curricular. Prazo médio: 3-12 meses.' },
    { title: 'Faça adaptação se necessário', description: 'Se faltarem disciplinas, matricule-se e cumpra as exigências pendentes.' },
    { title: 'Obtenha diploma revalidado', description: 'Após aprovação, a universidade emite o diploma de revalidação, válido em todo o Brasil.' },
  ],
  [
    { title: 'Médicos e áreas regulamentadas', text: 'Medicina, odontologia, enfermagem e outras áreas da saúde exigem revalidação de diploma + revalidação de registro profissional no conselho de classe.' },
    { title: 'Pós-graduação no exterior', text: 'Mestrado e doutorado no exterior geralmente são reconhecidos automaticamente se a instituição for reconhecida no país de origem. Mas verifique com a universidade brasileira.' },
    { title: 'Comece antes de voltar', text: 'Se planeja retornar ao Brasil, comece a reunir documentação e pesquisar universidades enquanto ainda está no exterior.' },
  ],
  ['revalidacao-diploma-exterior', 'trabalho-direitos-exterior']
);

// === FAMILIA ===
g('casamento-exterior-reconhecimento',
  'Casamento no exterior: como fazer reconhecimento no Brasil',
  'familia',
  'Casou fora do Brasil? Saiba como fazer o reconhecimento da união no Brasil, atualizar documentos e garantir todos os direitos.',
  '10 min', '17 de abril de 2026',
  [
  ...
  [
    { title: 'Obtenha certidão de casamento', description: 'Solicite no cartório/local de registro do país onde casou.' },
    { title: 'Apostile ou legalize', description: 'Se o país for signatário da Convenção de Haia, apostile. Se não, legalize no consulado brasileiro.' },
    { title: 'Traduza juramentadamente', description: 'Traduza a certidão para português por tradutor juramentado no Brasil ou no exterior.' },
    { title: 'Registre no consulado', description: 'Leve documentos ao consulado brasileiro e solicite registro do casamento.' },
    { title: 'Atualize documentos brasileiros', description: 'CPF, passaporte, título de eleitor e cadastros em bancos e empresas.' },
  ],
  [
    { title: 'Pacto antenupcial', text: 'Se fez pacto antenupcial (pre-nup) no exterior, ele também precisa ser reconhecido no Brasil. Consulte um advogado de família.' },
    { title: 'Casamento entre brasileiros', text: 'Se ambos são brasileiros, o processo no consulado é mais direto. Se um é estrangeiro, podem ser exigidos documentos adicionais.' },
    { title: 'União estável', text: 'Se vive em união estável no exterior, o reconhecimento segue processo similar ao casamento. Documente a vida em comum (contas conjuntas, contrato de aluguel, etc.).' },
  ],
  ['registro-nascimento-filho-exterior', 'divorcio-exterior-brasil', 'certidoes-exterior']
);

g('registro-nascimento-filho-exterior',
  'Como registrar nascimento de filho no exterior no Brasil',
  'familia',
  'Seu filho nasceu fora do Brasil? Saiba como fazer o registro no consulado, obter a certidão e garantir a cidadania brasileira.',
  '9 min', '15 de abril de 2026',
  [
  ...
  [
    { title: 'Obtenha certidão local', description: 'Solicite a certidão de nascimento no hospital ou cartório do país onde nasceu.' },
    { title: 'Apostile ou legalize', description: 'Apostille (Convenção de Haia) ou legalize no consulado brasileiro.' },
    { title: 'Traduza para português', description: 'Tradução juramentada é obrigatória para o registro brasileiro.' },
    { title: 'Agende no consulado', description: 'Marque atendimento no consulado brasileiro e leve todos os documentos + passaportes dos pais.' },
    { title: 'Registre e obtenha documentos', description: 'Após o registro, solicite CPF e passaporte brasileiro para a criança.' },
  ],
  [
    { title: 'Prazo ideal', text: 'Registre o quanto antes. Quanto mais tempo passa, mais burocrático pode ficar, especialmente se os pais mudarem de endereço no exterior.' },
    { title: 'Dupla cidadania', text: 'Se o país de nascimento concede cidadania por solo (jus soli), como EUA, Canadá e vários países latino-americanos, seu filho terá dupla cidadania. Isso é uma vantagem enorme para o futuro dele.' },
    { title: 'Registro tardio', text: 'Se o filho já tem anos e não foi registrado, ainda é possível, mas pode exigir investigação de filiação e processo mais longo. Não deixe para depois.' },
  ],
  ['casamento-exterior-reconhecimento', 'passaporte-brasileiro-exterior', 'cidadania-europeia']
);

g('divorcio-exterior-brasil',
  'Divórcio no exterior: validade no Brasil e o que fazer depois',
  'familia',
  'Se divorciou fora do Brasil, a sentença precisa ser reconhecida aqui. Entenda o processo de homologação e como atualizar sua situação.',
  '9 min', '13 de abril de 2026',
  [
  ...
  [
    { title: 'Obtenha sentença definitiva', description: 'Certifique-se de que o divórcio está definitivo no país onde foi realizado.' },
    { title: 'Apostile e traduza', description: 'Apostile a sentença (Convenção de Haia) e traduza por tradutor juramentado.' },
    { title: 'Contrate advogado no Brasil', description: 'A homologação no STJ exige advogado brasileiro com inscrição no Brasil.' },
    { title: 'Petição ao STJ', description: 'O advogado prepara e envia a petição de homologação com todos os documentos.' },
    { title: 'Aguarde decisão', description: 'Prazo médio: 6 meses a 2 anos. O STJ pode pedir informações adicionais.' },
    { title: 'Transcreva e atualize', description: 'Após homologação, transcreva a sentença no Registro Civil e atualize documentos.' },
  ],
  [
    { title: 'Custódia de filhos', text: 'Se o divórcio envolve guarda de filhos, a homologação pode ser mais complexa. O STJ verifica se a decisão está de acordo com o Estatuto da Criança e do Adolescente brasileiro.' },
    { title: 'Bens no Brasil', text: 'Se houver bens no Brasil, a partilha deverá ser cumprida aqui. A homologação da sentença estrangeira facilita, mas pode ser necessário processo adicional para execução.' },
    { title: 'Novo casamento', text: 'Não é possível casar no Brasil antes da homologação do divórcio estrangeiro. Planeje-se com antecedência se pretende se casar novamente no Brasil.' },
  ],
  ['casamento-exterior-reconhecimento', 'registro-nascimento-filho-exterior', 'testamentos-heranca']
);

// === IMOVEIS ===
g('comprar-imovel-brasil-exterior',
  'Como comprar imóvel no Brasil morando no exterior',
  'imoveis',
  'Quer investir ou ter um pé-de-meia no Brasil? Guia completo sobre como comprar imóvel à distância, documentos necessários e cuidados jurídicos.',
  '13 min', '23 de abril de 2026',
  [
  ...
  [
    { title: 'Regularize CPF', description: 'CPF ativo e com endereço atualizado é pré-requisito para qualquer transação imobiliária.' },
    { title: 'Defina orçamento e local', description: 'Pesquise bairros, valores e defina se compra à vista ou busca alternativas de financiamento.' },
    { title: 'Contrate advogado e corretor', description: 'Profissionais de confiança no Brasil são seus olhos e ouvidos no processo.' },
    { title: 'Faça procuração', description: 'Dê procuração ao advogado ou a um familiar de confiança para assinar documentos em seu nome.' },
    { title: 'Pesquise o imóvel', description: 'Certidão de matrícula, ônus reais, débitos, vistoria. Não pule nenhuma etapa.' },
    { title: 'Assinatura e registro', description: 'Escritura pública, pagamento de ITBI e registro no cartório de imóveis.' },
  ],
  [
    { title: 'Procuração pública', text: 'A procuração deve ser feita em cartório no Brasil ou no consulado brasileiro no exterior. Verifique quais poderes são necessários (compra, venda, locação, financiamento).' },
    { title: 'Investimento estrangeiro', text: 'A compra de imóvel por não residente é considerada investimento estrangeiro e deve ser informada ao Banco Central se acima de certos limites. Seu advogado pode orientar.' },
    { title: 'Aluguel para pagar financiamento', text: 'Se comprar para investir, o aluguel pode cobrir parte do custo. Mas lembre: aluguel no Brasil é tributável e exige nota fiscal em muitos municípios.' },
  ],
  ['vender-imovel-brasil-exterior', 'conta-bancaria-brasil', 'declaracao-saida-definitiva']
);

g('vender-imovel-brasil-exterior',
  ...
  [
    { title: 'Reúna documentação', description: 'Matrícula, ônus reais, quições, autorizações necessárias.' },
    { title: 'Avalie o imóvel', description: 'Contrate avaliação profissional ou pesquise valores de mercado na região.' },
    { title: 'Dê procuração', description: 'Procuração específica para venda do imóvel a alguém de confiança no Brasil.' },
    { title: 'Coloque à venda', description: 'Corretor, plataformas imobiliárias, divulgação. Seu procurado pode mostrar o imóvel.' },
    { title: 'Negocie e feche', description: 'Contrato de compra e venda, sinal, prazo para pagamento e escrita.' },
    { title: 'Pague impostos e registre', description: 'Recolha IR sobre ganho de capital e registre a transferência no cartório.' },
  ],
  [
    { title: 'Ganho de capital de não residente', text: 'Não residentes pagam IR sobre ganho de capital na fonte, na escritura. O cartório retém o imposto e recolhe à Receita Federal.' },
    { title: 'Isenção de reinvestimento', text: 'A isenção por reinvestir em outro imóvel residencial no Brasil é válida para não residentes? Infelizmente, não. Essa isenção é só para residentes fiscais no Brasil.' },
    { title: 'Moeda estrangeira', text: 'Se o comprador pagar em moeda estrangeira, o valor deve ser convertido para reais na data da escritura. Use câmbio comercial do Banco Central.' },
  ],
  ['comprar-imovel-brasil-exterior', 'testamentos-heranca', 'imposto-renda-exterior']
);

g('testamentos-heranca',
  'Testamentos e herança para brasileiros no exterior',
  'imoveis',
  'Proteja sua família e seu patrimônio. Entenda como fazer testamentos válidos no Brasil e no exterior, e como funciona o inventário para não residentes.',
  '11 min', '18 de abril de 2026',
  [
  ...
  [
    { title: 'Liste todos os bens', description: 'No Brasil e no exterior. Imóveis, contas, investimentos, empresas, seguros de vida.' },
    { title: 'Consulte advogados', description: 'Um no Brasil (direito brasileiro) e outro no país de residência (direito local).' },
    { title: 'Faça testamento(s)', description: 'Testamento no Brasil (por procuração se necessário) e, se aconselhável, no país de residência.' },
    { title: 'Informe herdeiros', description: 'Diga à família onde estão os testamentos, senhas de contas e documentos importantes.' },
    { title: 'Revise periodicamente', description: 'Testamentos não são eternos. Revise a cada 3-5 anos ou quando houver mudanças significativas.' },
  ],
  [
    { title: 'Procuração para inventário', text: 'Dê procuração a alguém de confiança no Brasil para lidar com inventário futuro. Isso economiza meses de burocracia.' },
    { title: 'Seguro de vida internacional', text: 'Seguros de vida com beneficiários definidos passam fora do inventário, acelerando o acesso ao dinheiro pela família.' },
    { title: 'Contas conjuntas', text: 'Contas bancárias conjuntas com direito de sobrevivência também passam fora do inventário, mas tenha cuidado: o co-titular tem acesso imediato a todo o dinheiro.' },
  ],
  ['comprar-imovel-brasil-exterior', 'vender-imovel-brasil-exterior', 'divorcio-exterior-brasil']
);

// === TRABALHO ===
g('nota-fiscal-exterior',
  'Como emitir nota fiscal para clientes no exterior',
  'trabalho',
  'Você presta serviço para cliente brasileiro ou estrangeiro? Saiba como emitir nota fiscal corretamente, qual CFOP usar e como funciona a tributação.',
  '10 min', '21 de abril de 2026',
  [
  ...
  [
    { title: 'Identifique o cliente', description: 'É brasileiro ou estrangeiro? Tem CNPJ/CPF no Brasil? Isso define toda a operação.' },
    { title: 'Verifique regras do município', description: 'Cada prefeitura tem regras diferentes para notas de serviço para o exterior. Consulte o site da sua prefeitura.' },
    { title: 'Converta valor para reais', description: 'Use câmbio comercial do dia. Documente a fonte da cotação.' },
    { title: 'Emita a nota fiscal', description: 'Preencha corretamente CFOP, dados do cliente, descrição do serviço e valor em reais.' },
    { title: 'Envie ao cliente e guarde', description: 'Envie por email e arquive a nota para fins contábeis e fiscais.' },
  ],
  [
    { title: 'Contrato internacional', text: 'Tenha um contrato claro com cliente estrangeiro: escopo, prazo, valor, moeda, forma de pagamento. Isso evita disputas e facilita comprovação fiscal.' },
    { title: 'Recebimento em moeda estrangeira', text: 'Quando recebe em dólar/euro, a conversão para a nota deve ser feita na data do fato gerador. Se o câmbio mudar entre emissão e recebimento, pode haver ganho/perda cambial tributável.' },
    { title: 'Simples Nacional', text: 'Se é MEI ou Simples Nacional, a nota para cliente no exterior pode ter tratamento diferenciado. Confirme com seu contador antes de emitir.' },
  ],
  ['mei-cnpj-exterior', 'precificar-servicos-exterior', 'enviar-dinheiro-exterior']
);

// === MUDANCA ===
g('mudanca-exterior-checklist',
  'Checklist definitivo da mudança para o exterior: o que levar, o que vender e o que esquecer',
  'mudanca',
  'A mudança para fora do Brasil é um marco. Use este checklist completo para não esquecer nada importante e não carregar o que não precisa.',
  '12 min', '24 de abril de 2026',
  [
  ...
  [
    { title: 'Digitalize documentos', description: 'Escaneie todos os documentos importantes e guarde na nuvem + pendrive.' },
    { title: 'Venda o que não vai levar', description: 'Use OLX, Facebook Marketplace, bazares. Quanto antes começar, melhores os preços.' },
    { title: 'Separe remédios e documentos', description: 'Leve na bagagem de mão. Nunca na bagagem despachada.' },
    { title: 'Verifique voltagem e padrões', description: 'Eletrônicos brasileiros são 127/220V. Muitos países usam 110V ou 240V. Verifique antes de levar.' },
    { title: 'Contrate transporte', description: 'Container, frete aéreo ou correio. Compare prazos, taxas e seguros.' },
    { title: 'Deixe procuração e contatos', description: 'Alguém no Brasil precisa poder resolver coisas por você nos primeiros meses.' },
  ],
  [
    { title: 'Peso da bagagem', text: 'A maioria das companhias aéreas permite 2 malas de 23kg cada para voos internacionais. Pague excesso antecipado se precisar — é mais barato que no aeroporto.' },
    { title: 'Seguro de mudança', text: 'Contrate seguro para o transporte de suas coisas. Containeres às vezes sofrem avarias, roubos ou atrasos.' },
    { title: 'Doação', text: 'O que não conseguir vender, doe. Há ONGs que buscam móveis e roupas em casa. Você ajuda alguém e não precisa jogar fora.' },
  ],
  ['cnh-exterior', 'conta-bancaria-brasil', 'declaracao-saida-definitiva']
);

// === VEICULOS ===
g('cnh-exterior',
  'CNH brasileira no exterior: validade, troca e como dirigir legalmente',
  'veiculos',
  'Sua CNH vale no exterior? Depende do país. Veja onde pode usar diretamente, onde precisa trocar e como fazer a Permissão Internacional para Dirigir.',
  '10 min', '22 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique regras do país', description: 'Cada país tem regras diferentes. Consulte o site do órgão de trânsito local.' },
    { title: 'Obtenha PID', description: 'Solicite a Permissão Internacional para Dirigir no Detran antes de viajar.' },
    { title: 'Renove CNH se necessário', description: 'Se está perto de vencer, renove no Brasil antes de sair.' },
    { title: 'Inicie troca no prazo', description: 'Não espere o prazo acabar. Comece o processo de troca assim que chegar ao país de destino.' },
    { title: 'Faça exames necessários', description: 'Médico, teórico e/ou prático conforme exigido pelo país.' },
  ],
  [
    { title: 'Seguro de carro', text: 'Seguradoras no exterior podem não cobrir acidentes se você estiver dirigindo com CNH brasileira além do prazo permitido. Troque a carteira antes de contratar seguro anual.' },
    { title: 'Aluguel de carro', text: 'Locadoras de veículos geralmente aceitam CNH brasileira + PID para turistas. Mas para residentes, podem exigir carteira local.' },
    { title: 'Pontuação no Brasil', text: 'Mesmo morando no exterior, infrações cometidas no Brasil continuam registradas na sua CNH. Multas não pagas podem impedir renovação futura.' },
  ],
  ['mudanca-exterior-checklist', 'conta-bancaria-brasil']
);

// === CIDADANIA ===
g('voto-exterior',
  'Como votar no exterior: guia completo para brasileiros fora do país',
  'cidadania',
  'Voto é obrigatório mesmo fora do Brasil? Como se cadastrar? Veja tudo sobre votação no exterior, zonas eleitorais e como justificar.',
  '9 min', '20 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique situação eleitoral', description: 'Acesse o site do TSE e consulte se está regular ou se há multas pendentes.' },
    { title: 'Transfira ou justifique', description: 'Se mora permanentemente no exterior, transfira o título. Se está temporariamente, justifique as ausências.' },
    { title: 'Compareça ao consulado', description: 'Para transferência, biometria no consulado é obrigatória em muitos casos. Agende com antecedência.' },
    { title: 'Vote ou justifique sempre', description: 'Nas eleições, vote no consulado ou justifique a ausência no prazo de 60 dias.' },
    { title: 'Quite multas se houver', description: 'Multas podem ser pagas no site do TSE ou em qualquer banco brasileiro.' },
  ],
  [
    { title: 'e-Título', text: 'Baixe o aplicativo e-Título. Ele permite consultar situação, justificar ausência, pagar multas e solicitar transferência direto pelo celular.' },
    { title: 'Eleições no consulado', text: 'As seções eleitorais no exterior costumam ter filas. Chegue cedo e leve documento com foto.' },
    { title: 'Regularize antes de precisar', text: 'Se planeja tirar passaporte novo ou fazer algum processo que exija certidão de quitação eleitoral, regularize sua situação com antecedência.' },
  ],
  ['cidadania-europeia', 'cpf-regularizado-exterior']
);

g('cidadania-europeia',
  'Cidadania europeia para brasileiros: Portugal, Itália, Espanha e mais',
  'cidadania',
  'Sonha em ter passaporte europeu? Veja como funciona a cidadania por ascendência nos principais países e o que você precisa para começar.',
  '14 min', '17 de abril de 2026',
  [
  ...
  [
    { title: 'Pesquise sua ascendência', description: 'Fale com familiares, pesquise registros. Identifique de qual país vem seu ascendente europeu.' },
    { title: 'Reúna certidões', description: 'Nascimento, casamento e óbito de todos na linha direta, desde o ascendente europeu até você.' },
    { title: 'Apostile e traduza', description: 'Apostille (Convenção de Haia) e traduza juramentadamente para o idioma do país de origem.' },
    { title: 'Agende no consulado', description: 'Consulados costumam ter filas enormes. Agende o quanto antes (às vezes anos de espera).' },
    { title: 'Apresente documentação', description: 'Leve todos os documentos ao consulado e aguarde análise.' },
    { title: 'Conclua o processo', description: 'Se aprovado, obtenha passaporte europeu e aproveite os direitos de cidadão da UE.' },
  ],
  [
    { title: 'Naturalização do ascendente', text: 'No caso italiano, se seu avô italiano se naturalizou brasileiro ANTES do nascimento do seu pai, a linha foi quebrada e você não tem direito. Se naturalizou DEPOIS, você tem direito.' },
    { title: 'Processo na Itália', text: 'Fazer o processo na Itália (em vez do consulado no Brasil) é geralmente mais rápido, mas exige que você more lá por alguns meses.' },
    { title: 'Advogado especializado', text: 'Processos de cidadania são burocráticos e demorados. Um advogado ou assessoria especializada pode economizar anos de dor de cabeça.' },
  ],
  ['passaporte-brasileiro-exterior', 'certidoes-exterior', 'registro-nascimento-filho-exterior']
);

// === COMPRAS ===
g('comprar-brasil-receber-exterior',
  'Como comprar no Brasil e receber no exterior: guia completo de remessas e encomendas',
  'compras',
  'Quer comprar produtos brasileiros ou receber encomendas de familiares? Entenda taxas, tributação, limites e as melhores formas de envio.',
  '11 min', '19 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique regras do destino', description: 'Cada país tem limites e proibições diferentes. Pesquise antes de comprar/enviar.' },
    { title: 'Declare corretamente', description: 'Especifique conteúdo, valor e finalidade (compra, presente, amostra) com precisão.' },
    { title: 'Escolha modalidade de envio', description: 'Compare Correios, transportadoras (DHL, FedEx) e redirecionadores por preço, prazo e rastreamento.' },
    { title: 'Acompanhe rastreamento', description: 'Guarde o código de rastreamento e acompanhe até a entrega.' },
    { title: 'Pague impostos se necessário', description: 'Se a encomenda for tributada no destino, pague para liberar a entrega.' },
  ],
  [
    { title: 'Limite de isenção', text: 'Conheça o limite de isenção do país de destino. Dividir compras em remessas menores pode ser vantajoso, mas cuidado: enviar muitas remessas seguidas pode ser interpretado como fraude de importação.' },
    { title: 'Seguro de envio', text: 'Sempre declare o valor real e contrate seguro. Se a encomenda se perder, você será reembolsado pelo valor declarado.' },
    { title: 'Comida brasileira', text: 'Produtos industrializados (café, doces, farinha) geralmente são aceitos. Produtos frescos (queijos, carnes) são proibidos na maioria dos países.' },
  ],
  ['enviar-dinheiro-exterior', 'comprar-imovel-brasil-exterior']
);

// === COMUNICACAO ===
g('manter-celular-brasil-exterior',
  'Como manter número de celular brasileiro no exterior',
  'comunicacao',
  'Receber SMS do banco, WhatsApp com contatos e códigos de verificação: manter seu número brasileiro é essencial. Veja as melhores opções.',
  '8 min', '15 de abril de 2026',
  [
  ...
  [
    { title: 'Verifique opções da operadora', description: 'Ligue para sua operadora e pergunte sobre planos para manter número no exterior.' },
    { title: 'Ative roaming', description: 'Mesmo que não use, ative roaming para receber SMS e ligações.' },
    { title: 'Considere dual chip', description: 'Celular com dois chips permite usar número brasileiro e local simultaneamente.' },
    { title: 'Migre WhatsApp com cuidado', description: 'Mudar número do WhatsApp pode perder grupos. Faça backup antes.' },
    { title: 'Teste recebimento de SMS', description: 'Verifique se consegue receber SMS de bancos e apps importantes com sua configuração.' },
  ],
  [
    { title: 'Plano mínimo', text: 'A maioria das operadoras tem planos de manutenção de número por menos de R$ 30/mês. Não precisa manter plano completo.' },
    { title: 'Dual SIM', text: 'iPhones a partir do XS e a maioria dos Androids modernos suportam dual SIM (físico + eSIM). Isso facilita muito.' },
    { title: 'Cuidado com portabilidade VoIP', text: 'Alguns bancos e serviços não aceitam números VoIP para verificação em duas etapas. Teste antes de migrar definitivamente.' },
  ],
  ['conta-bancaria-brasil', 'enviar-dinheiro-exterior']
);

const header = `export interface GuideStep {
  title: string
  description: string
}
...
const output = header + JSON.stringify(GUIDES, null, 2) + '\n';
fs.writeFileSync('lib/guides-data.ts', output, 'utf8');
console.log('Created lib/guides-data.ts with', GUIDES.length, 'guides');
